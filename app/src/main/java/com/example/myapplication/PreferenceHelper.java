...
public class PreferenceHelper {
    ...
    public static final String KEY_AUDIO_TYPE = getPreferenceString(R.string.key_audio_type);
    public static final String KEY_ENABLE_WIFI_AP = getPreferenceString(R.string.key_enable_wifi_ap);
    public static final String KEY_CONNECTION_TIMEOUT_MILLISECONDS = getPreferenceString(R.string.connection_timeout_key);
    public static final String KEY_FAVORITE_DEVICE_IP = getPreferenceString(R.string.favorite_device_ip_key);
    public static final String KEY_FAVORITE_DEVICE_NAME = getPreferenceString(R.string.favorite_device_name_key);
    ...
    private static final boolean DEFAULT_ENABLE_WiFi_AP = false;
    ...
    /**
     * @return Preferred audio type
     */
    public String getAudioType() {
        return m_sharedPreferences.getString(KEY_AUDIO_TYPE, "");
    }
    ...
    public boolean isWiFiApEnabled() {
        return m_sharedPreferences.getBoolean(KEY_ENABLE_WIFI_AP, DEFAULT_ENABLE_WiFi_AP);
    }

    public int getConnectionTimeout() {
        String pinTimeoutInterval = m_sharedPreferences.getString(KEY_CONNECTION_TIMEOUT_MILLISECONDS, "");
        if (!pinTimeoutInterval.isEmpty()) {
            try {
                return Integer.parseInt(pinTimeoutInterval);
            } catch (NumberFormatException e) {
                MCSLogger.log(MCSLogger.eWarning, "Invalid pin timeout configured!");
            }
        }
        return DEFAULT_CONNECTION_TIMEOUT_MS;
    }
    public String getFavoriteDeviceIP() {
        return  m_sharedPreferences.getString(KEY_FAVORITE_DEVICE_IP, "");
    }

    public String getFavoriteDeviceName() {
        return  m_sharedPreferences.getString(KEY_FAVORITE_DEVICE_NAME, "");
    }
